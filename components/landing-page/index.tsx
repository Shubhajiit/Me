      ...
      <div className="flex flex-col md:grid md:grid-cols-2 gap-12 items-center justify-center min-h-screen max-w-screen-lg mt-16 md:mt-60 mx-4 xl:mx-auto relative z-20">
        ...
        >
          <div className="relative group">
            ...
            >
              ...
              <Image
                src="/profile/coder.jpg"
                alt="Profile Picture"
                width={450}
                height={450}
                className="h-[250px] sm:h-[250px] md:h-[400px] lg:h-[450px] w-[250px] md:w-[300px] lg:w-[450px] object-cover rounded-3xl relative z-10"
              />
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row justify-center md:justify-start gap-4 mt-4 w-full relative z-50"
          >
            <Button
              asChild
              className="w-full sm:w-auto text-lg bg-secondary text-secondary-foreground hover:bg-secondary/80 border border-border shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer"
              variant="secondary"
              size="lg"
            >
              <motion.a
            ...
            <Button
              asChild
              className="w-full sm:w-auto text-lg bg-primary text-primary-foreground hover:bg-primary/90 shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer"
              variant="default"
              size="lg"
            >
              <motion.a
  ...
  return (
    ...
    >
      ...
      <motion.span whileHover={{ scale: 1.05 }} transition={{ duration: 0.2 }}>
        <Cover className="cursor-crosshair text-primary">Shubhajit</Cover>
      </motion.span>
    </motion.h1>
  );
});
